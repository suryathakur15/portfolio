      ...
      <div className="section-container py-20 md:py-28 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-14 mb-16 md:mb-20">
          ...
          <div className="flex flex-col items-start max-w-lg">
            ...
            <a
              href={`mailto:${EMAIL}`}
              className="group inline-flex items-center gap-3 font-display font-bold text-white/90 hover:text-white transition-colors duration-300 text-lg sm:text-xl md:text-2xl"
            >
              <span className="underline underline-offset-4 decoration-white/20 group-hover:decoration-white/40 break-all">
                {EMAIL}
              </span>
              <svg
