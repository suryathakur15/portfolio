  ...
  return (
    ...
    >
      <div className="flex flex-col mb-16">
        <p className="text-accent-primary font-accent text-3xl mb-4">
          Selected Works
        </p>
        ...
        <h2 className="text-xl opacity-70 max-w-2xl">
          From high-frequency sports engines to AI-driven social platforms. A
          curated selection of systems I've built and scaled.
        </h2>
      </div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  {project.tech.slice(0, 3).map((t) => (
                    <span
                      key={t}
                      className="px-2 py-0.5 rounded-md border border-white/10 text-[9px] font-bold text-white/30 uppercase tracking-tighter"
                    >
                      {t}
                    </span>
                  ))}
